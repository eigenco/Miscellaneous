...
int13.asm: Hacked VGABIOS for Trident TVGA 9000i allowing boot from Sound Blaster AWE64 IDE. The final binary files are generated by checksum.py which corrects the checksum byte and interleaves the data as required by the board.
